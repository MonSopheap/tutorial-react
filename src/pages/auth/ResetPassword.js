                            ...
                            <button type='submit' className="w-full py-2 font-sm text-white bg-indigo-600 hover:bg-indigo-500 rounded-md border-indigo-500 hover:shadow inline-flex items-center justify-center">

                                {
                                    !loading ? <>
                                        ...
                                        <span className='ml-1 text-sm'>Reset password</span></> : <><svg aria-hidden="true" role="status" className="inline w-4 h-4 mr-2 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
